...
### B. Demonstration of Use-Cases
Examples of input and output (i.e. REST requests), documented in text, to showcase each use case

| Use Case | Description | Class |
| --- | --- | --- |
| 1 | Create/update Customer | Customer |
| 2 | Create/update Customer Contact | Contact |
| 3 | Look up Customer basic info and Contact | Customer |

#### Return all customers (Use-Case 3)
```bash
...
### C. Instructions to Build and Run
Instruction of building the Jar file and running the application with the input requests
...
Run:
```
java -jar customerSystem-0.0.1-SNAPSHOT.jar
```
